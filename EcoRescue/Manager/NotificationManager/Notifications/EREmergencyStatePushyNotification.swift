//
//  EREmergencyStatePushyNotification.swift
//  EcoRescue
//
...
private let kTypeIdentifier = "EmergencyStatePushyIdentifier"
private let kType           = "EmergencyStatePushy"

class EREmergencyStatePushyNotification: ERNotification {
