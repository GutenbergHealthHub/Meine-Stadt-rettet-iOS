//
//  ERAddDefibrillatorAddressView.swift
//  EcoRescueASB
//
//  Created by Birtan on 11.01.19.
//  Copyright © 2019 Birtan Gültekin. All rights reserved.
//

import UIKit

class ERAddDefibrillatorAddressView: Control {
    ...
    override init() {
        ...
        height(constant: UITextFieldHeight.forScreenSize * 1.5).apply()
    }
