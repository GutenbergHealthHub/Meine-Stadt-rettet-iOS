//
//  ERProtocolRemarksViewController.swift
//  EcoRescue
//
...
class ERProtocolRemarksViewController: StepsViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        headerTitleLabel.text    = String.END_REMARKS_TITLE
        ...
        button.bottom(constant: UIViewPadding.large).leftright(constant: UIViewPadding.large).height(constant: 44).apply()
